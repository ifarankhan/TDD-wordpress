...
class Test_Register_Class_Initialization extends TestCase {
	 ...
	 *
	 * @covers \Faran\TDD\Register::init()
	 *
	 ...
	 *
	 * @covers \Faran\TDD\Register::add_first_name()
	 *
	 ...
	 * @param string $should_be      What name should be after all the sanitizing.
	 *
	 * @covers \Faran\TDD\Register::add_last_name()
	 *
	 * @dataProvider name_data
	 */
	 ...
	 *
	 * @covers \Faran\TDD\Register::validate_first_name()
	 *
	 ...
	 * @param string $sanitized_name Text returned after sanitize.
	 *
	 * @covers \Faran\TDD\Register::validate_last_name()
	 *
	 * @dataProvider validate_name_error_data
	 */
	 ...
	 * @param string $sanitized_name Text returned after sanitize.
	 *
	 * @covers \Faran\TDD\Register::save_first_name()
	 *
	 * @dataProvider validate_name_good_data
	 */
	 ...
	 * @param string $sanitized_name Text returned after sanitize.
	 *
	 * @covers \Faran\TDD\Register::save_last_name()
	 *
	 * @dataProvider validate_name_good_data
	 */
